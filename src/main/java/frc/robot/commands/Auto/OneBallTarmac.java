...
public class OneBallTarmac extends SequentialCommandGroup {
  /** Creates a new TaxiandShoot. */

  //private SendableChooser<Double> m_ShootChooser;
  
  public OneBallTarmac(SpeedyPuffJunior s_speedypuffjunior, Shooter s_shooter, Elevator s_elevator, ubIntake s_ubIntake, FrontIntake s_frontIntake, double relX, double relY) {
