...
public class OneBallLow extends SequentialCommandGroup {
  ...
  public OneBallLow(SpeedyPuffJunior drive, Shooter shooter, Elevator elevator) {
    ...
    addCommands(
      new SetShooterSpeed(s_shooter, kShooter.fntLG_FENDER_SP, kShooter.bckLG_FENDER_SP),
      ...
      new WaitCommand(5),
      new DriveFoward(s_speedypuffjunior, -8)
